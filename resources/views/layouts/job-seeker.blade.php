        ...
        <div class="flex flex-1">
            ...
            <aside class="fixed left-0 top-0 h-screen w-64 overflow-y-auto border-r border-gray-200 bg-white shadow-sm md:relative md:w-auto">
                ...
                <div class="border-b border-gray-200 px-6 py-6">
                    <a href="{{ route('job-seeker.dashboard') }}" class="flex items-center gap-2 text-2xl font-bold text-blue-600 no-underline">
                ...
                <nav class="space-y-2 p-4">
                    <a href="{{ route('job-seeker.dashboard') }}" class="flex items-center gap-3 rounded-xl px-4 py-2.5 font-medium transition-all {{ request()->routeIs('job-seeker.dashboard') ? 'bg-blue-100 text-blue-600' : 'text-slate-600 hover:bg-gray-100' }}">
                        <x-icon name="chart-bar" class="w-5 h-5" />
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('job-seeker.jobs') }}" class="flex items-center gap-3 rounded-xl px-4 py-2.5 font-medium transition-all {{ request()->routeIs('job-seeker.jobs') ? 'bg-blue-100 text-blue-600' : 'text-slate-600 hover:bg-gray-100' }}">
                        <x-icon name="briefcase" class="w-5 h-5" />
                        <span>Cari Lowongan</span>
                    </a>
                    <a href="{{ route('job-seeker.profile') }}" class="flex items-center gap-3 rounded-xl px-4 py-2.5 font-medium transition-all {{ request()->routeIs('job-seeker.profile') ? 'bg-blue-100 text-blue-600' : 'text-slate-600 hover:bg-gray-100' }}">
