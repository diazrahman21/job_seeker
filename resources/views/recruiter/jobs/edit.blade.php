@extends('layouts.recruiter', ['title' => 'Edit Lowongan'])
...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-500 mt-1">Perbarui informasi lowongan</p>
    </div>

    <!-- Form -->
    <x-card>
        <form action="{{ route('recruiter.jobs.update', $job->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
