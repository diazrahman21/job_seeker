...
<div class="space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Dashboard Recruiter</h1>
            <p class="text-slate-500 mt-1">Kelola lowongan dan pelamar dengan mudah</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <x-card title="Lowongan Terbaru">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('recruiter.jobs.show', $job->id) ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl bg-gray-50 hover:bg-blue-50 transition-colors border border-gray-100">
                        <div class="flex-1">
        ...
        <div>
            <x-card title="Status Pelamar">
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-slate-600">Applied</span>
                        <span class="font-semibold text-slate-900">{{ $applicantsByStatus['applied'] ?? 0 }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        ...
                        <span class="font-semibold text-slate-900">{{ $applicantsByStatus['review'] ?? 0 }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <span class="text-sm text-slate-600">Interview</span>
                        <span class="font-semibold text-slate-900">{{ $applicantsByStatus['interview'] ?? 0 }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <span class="text-sm text-slate-600">Hired</span>
                        <span class="font-semibold text-slate-900">{{ $applicantsByStatus['hired'] ?? 0 }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
